...
function Lab() {
  ...
  return <>
    ...
    <div className="relative z-10">
      <h1 className="text-3xl text-center my-10 gr-rb-dark headline block"
        style={{width: '300px', margin: '6rem auto 4rem'}}>Web APIs Gallery</h1>
          ...
          {items.map((item, i) => {
            return <div className="col-span-4 sm:col-span-2 md:col-span-1 bg-gray-900 w-full rounded-lg pb-4" key={i}>
              ...
              {/* {item.slug !== undefined && <Link href={item.slug !== '' ? item.slug : '/'} 
                className="bg-gray-600 block text-gray-400 py-1 px-2 hover:text-gray-200"
                target="_blank"
              ...
              <div onClick={() => {setIsOpen(true); setProduct(item)}} key={i}
                className="pt-8 py-4 cursor-pointer group hover:opacity-75">
                ...
                <div className="text-gray-200 text-sm text-center mb-4 group-hover:text-gray-200">Read More</div>
    ...
    <Modal
      ...
      <div className="bg-gray-700 w-full rounded-lg">
        <div className="bg-gray-500 w-full relative h-16"
          style={{borderTopLeftRadius: '0.5rem', borderTopRightRadius: '0.5rem'}}>
            ...
            {product.slug !== undefined && <Link href={product.slug !== '' ? product.slug : '/'}
              className="absolute top-0 right-0 mt-4 mr-4 border border-solid border-gray-300
                text-gray-200 text-sm py-1 px-2 rounded-lg"
                target="_blank"
                style={{background: 'rgba(35,35,47,0.5)'}}>View Docs
            </Link>}
          </div>
        ...
        <div className="px-10 py-10 -mt-8">
          ...
          <ul className="text-gray-200 text-lg mb-12 opacity-75">
...
const items = [
  {
    ...
    slug: 'https://developer.mozilla.org/en-US/docs/Web/API/Web_Audio_API',
  },
  {
    name: 'Bluetooth',
    ...
    slug: 'https://developer.mozilla.org/en-US/docs/Web/API/Web_Bluetooth_API',
  },
  {
    name: 'Canvas',
    browsers: { edge: true, firefox: true, safari: true, chrome: true, },
    ...
    slug: 'https://developer.mozilla.org/en-US/docs/Web/API/Canvas_API',
  },
  {
    name: 'Console',
    browsers: { edge: true, firefox: true, safari: true, chrome: true, },
    ...
    slug: 'https://developer.mozilla.org/en-US/docs/Web/API/Console_API',
  },
  {
    name: 'DOM',
    browsers: { edge: true, firefox: true, safari: true, chrome: true, },
    ...
    slug: 'https://developer.mozilla.org/en-US/docs/Web/API/Document_Object_Model',
  },
  {
    name: 'Drag & Drop',
    browsers: { edge: true, firefox: true, safari: true, chrome: true, },
    ...
    slug: 'https://developer.mozilla.org/en-US/docs/Web/API/HTML_Drag_and_Drop_API',
  },
  {
    name: 'Fetch',
    browsers: { edge: true, firefox: true, safari: true, chrome: true, },
    ...
    slug: 'https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API',
  },
  {
    name: 'File & Directory',
    ...
    slug: 'https://developer.mozilla.org/en-US/docs/Web/API/File_and_Directory_Entries_API',
  },
  {
    name: 'Fullscreen',
    browsers: { edge: true, firefox: true, safari: true, chrome: true, },
    ...
    slug: 'https://developer.mozilla.org/en-US/docs/Web/API/Fullscreen_API',
  },
  {
    name: 'Geolocation',
    browsers: { edge: true, firefox: true, safari: true, chrome: true, },
    ...
    slug: 'https://developer.mozilla.org/en-US/docs/Web/API/Geolocation_API',
  },
  {
    name: 'History',
    browsers: { edge: true, firefox: true, safari: true, chrome: true, },
    ...
    slug: 'https://developer.mozilla.org/en-US/docs/Web/API/History_API',
  },
  {
    name: 'Intersection',
    browsers: { edge: true, firefox: true, safari: true, chrome: true, },
    ...
    slug: 'https://developer.mozilla.org/en-US/docs/Web/API/Intersection_Observer_API',
  },
  {
    name: 'Media Stream',
    ...
    slug: 'https://developer.mozilla.org/en-US/docs/Web/API/Media_Streams_API',
  },
  {
    ...
    slug: 'https://developer.mozilla.org/en-US/docs/Web/API/Page_Visibility_API',
  },
  {
    ...
    slug: 'https://developer.mozilla.org/en-US/docs/Web/API/Payment_Request_API',
  },
  {
    name: 'Performance',
    browsers: { edge: true, firefox: true, safari: true, chrome: true, },
    ...
    slug: 'https://developer.mozilla.org/en-US/docs/Web/API/Performance_API',
  },
  {
    name: 'Permissions',
    browsers: { edge: true, firefox: true, safari: false, chrome: true, },
    ...
    slug: 'https://developer.mozilla.org/en-US/docs/Web/API/Permissions_API',
  },
  {
    name: 'Pointer & Touch',
    browsers: { edge: true, firefox: true, safari: true, chrome: true, },
    ...
    slug: 'https://developer.mozilla.org/en-US/docs/Web/API/Pointer_events',
  },
  {
    ...
    slug: 'https://developer.mozilla.org/en-US/docs/Web/API/Resize_Observer_API',
  },
  {
    name: 'Vibration',
    browsers: { edge: true, firefox: true, safari: false, chrome: true, },
    ...
    slug: 'https://developer.mozilla.org/en-US/docs/Web/API/Vibration_API',
  }
]
