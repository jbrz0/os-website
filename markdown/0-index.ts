...
const posts: Array<Post> = [
  ...
  },
  {
    id: 4,
    number: '004',
    url: "http://d2ml5pl4d66ya9.cloudfront.net/playground",
  ...
  },
  {
    ...
    isLab: false,
    onSite: false,
    filename: "008-sentiment-check",
    date: "Feb 15, 2024",
    coolness: 2,
    difficulty: "medium",
    tags: ["tools", "api", "experimental"],
    tech: ["Any Tech", "NextJS", "NodeJS", "React", "api"],
    title: "Sentiment Checker Web Tool",
    cover: "covers/sentiment-check.png",
    description: "A web app that scans subreddits and uses ai to determine overall sentiment",
  },
  {
    id: 9,
    number: '009',
    url: "https://oddscenes.notion.site/80fa7049523c47ec8ec49c5b3b533faa",
    slug: "prompt-builder",
    isLab: true,
    onSite: false,
    filename: "009-prompt-builder",
    date: "Feb 15, 2024",
    coolness: 2,
    difficulty: "easy",
    tags: ["web", "project", "software"],
    tech: ["Any Tech"],
    title: "Generative Images Prompt Builder",
    cover: "covers/prompt-builder.png",
    description: "A notion template setup for dynamic and detailed prompts for ai generations",
  },
  {
    id: 10,
    number: '010',
    url: "https://marketplace.visualstudio.com/items?itemName=oddscenes-theme.oddscenes-theme",
    slug: "os-vscode-theme",
    isLab: true,
    onSite: false,
    filename: "010-os-vscode-theme",
    date: "Feb 15, 2024", 
    coolness: 3,
    difficulty: "easy",
    tags: ["software", "tools", "design"],
    tech: ["Any Tech"],
    title: "Odd Scenes VScode UI Theme",
    cover: "covers/os-template.png",
    description: "A high contrast dark mode vscode theme styling the entire vscode UI",
  },
]
