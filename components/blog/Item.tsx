...
const Item: React.FC<Props> = (props) => {
  return <Link href={props.href}><a className="hover:opacity-75">
    <div className="mb-16">
      ...
      <p className={`text-md`} style={{color: '#546a90'}}>Another difficulty with wireframes is that they don’t. Another difficulty with wireframes is that they don’t. Another difficulty.</p>
    </div>
  </a></Link>
}
