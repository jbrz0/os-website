  ...
  if (sorted.length < 1) return <p className="text-gray-200">Loading</p>
    ...
    <div className="px-12 sm:px-16 lg:px-auto py-20 md:py-40 bg-gray-1000 home-labs">
      <div className="container mx-auto mb-8 sm:mb-6 lg:mb-auto lg:px-12 xl:px-24">
        ...
        <Link href={`/blog/${sorted[sorted.length - 1].slug}`} className="hover:opacity-75">
      ...
      <div className="container mx-auto lg:px-12 xl:px-24 grid grid-cols-3 gap-5 sm:gap-8">
          ...
          <div className="col-span-3 sm:col-span-1 rounded-sm">
            <Link href={`/blog/${sorted[sorted.length - 2].slug}`} className="hover:opacity-75">
          ...
          <div className="col-span-3 sm:col-span-1 rounded-sm">
            <Link href={`/blog/${sorted[sorted.length - 3].slug}`} className="hover:opacity-75">
          ...
          <div className="col-span-3 sm:col-span-1 rounded-sm">
            <Link href={`/blog/${sorted[sorted.length - 4].slug}`} className="hover:opacity-75">
    ...
    <div className="py-20 md:py-32 lg:py-40 bg-black bg-cover bg-no-repeat shadow-2xl" style={{backgroundImage: `url(/icons/waves.svg)`}}>
      ...
      <Link href={`/blog/${sorted[sorted.length - 5].slug}`} className="md:col-span-4 lg:col-span-1 mb-4 md:mb-auto max-w-sm md:max-w-none mx-auto">
      ...
      <Link href={`/blog/${sorted[sorted.length - 6].slug}`} className="md:col-span-2 lg:col-span-1 mb-4 md:mb-auto max-w-sm md:max-w-none mx-auto">
        <div className="bg-gray-100 rounded-sm shadow-lg p-8 group cursor-pointer hover:bg-purple">
      ...
      <Link href={`/blog/${sorted[sorted.length - 7].slug}`} className="md:col-span-2 lg:col-span-1 max-w-sm md:max-w-none mx-auto">
        <div className="bg-gray-100 rounded-sm shadow-lg p-8 group cursor-pointer hover:bg-purple">
