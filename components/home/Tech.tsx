...
function Tech() {
  return <div className="py-40 bg-black shadow-2xl">
    ...
    <div className="container mx-auto px-24 grid grid-cols-12 gap-2 mb-2">
    ...
    <div className="container mx-auto px-24 grid grid-cols-12 gap-2">
      <div className="col-span-1 bg-gray-1000 rounded h-16"></div>
      <div className="col-span-1 bg-gray-1000 rounded h-16"></div>
      <div className="col-span-1 bg-gray-1000 rounded h-16"></div>
      <div className="col-span-1 bg-gray-1000 rounded h-16"></div>
    ...
    <div className="container mx-auto px-24 text-gray-200 mt-5">
